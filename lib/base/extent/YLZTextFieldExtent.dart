...
///
class YLZTextFieldExtent extends StatefulWidget {
  const YLZTextFieldExtent({
    Key? key,
    required this.child,
  ...
  @override
  _YLZTextFieldExtentState createState() => new _YLZTextFieldExtentState();
}

///
/// We implement the WidgetsBindingObserver to be notified of any change to the window metrics
///
class _YLZTextFieldExtentState extends State<YLZTextFieldExtent>
