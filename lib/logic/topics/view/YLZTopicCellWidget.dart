...
typedef void YLZTopicCellWidgetClickListener(int idStr);

class YLZTopicCellWidget extends StatefulWidget {
  final YLZListModel listModel;
  final YLZTopicCellWidgetClickListener topicCellWidgetClickListener;

  const YLZTopicCellWidget(
      {Key? key,
  ...
  @override
  _YLZTopicCellWidgetState createState() => _YLZTopicCellWidgetState();
}

class _YLZTopicCellWidgetState extends State<YLZTopicCellWidget> {
  @override
  ...
  Widget _buildPicWidget(YLZListModel model) {
