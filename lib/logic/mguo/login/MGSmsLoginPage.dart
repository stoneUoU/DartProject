...
class MGSmsLoginPage extends StatefulWidget {
  /// 倒计时的秒数，默认60秒。
  final int countdown = 60;

  MGSmsLoginPage({Key? key}) : super(key: key);

  @override
  _MGSmsLoginPageState createState() => _MGSmsLoginPageState();
}

class _MGSmsLoginPageState extends State<MGSmsLoginPage> {
  /// 倒计时的计时器。
  late Timer _timer;
